...
const auth_controller_4 = require("../controllers/auth.controller");
const router = (0, express_1.Router)();
router.post('/register', auth_controller_1.registerUser);
router.post('/login', auth_controller_1.loginUser);
router.post('/forgot-password', auth_controller_3.forgotPassword);
router.put('/reset-password/:resettoken', auth_controller_4.resetPassword);
